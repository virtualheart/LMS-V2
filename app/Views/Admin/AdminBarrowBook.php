        ...
        <form method="POST" id="bookForm">
         ...
         <!--  <div class="form-group col-md-5">
                ...
                <div class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" value="" name="bcode" required>
                </div>

                <div class="form-group col-md-5">
                    <label>Book No</label>
                    <input type="text" class="form-control" value="" name="bno" required>
                </div>
                <div class="form-group col-md-5">
                    <label>Title</label>
                ...
                <div class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" value="" name="aname" required>
                </div>
                <div class="form-group col-md-5">
                    <label>Publication</label>
                    <input type="text" class="form-control" value="" name="publication" required>
                </div>
                <div class="form-group col-md-5">
                    <label>Price</label>
                ...
                <div class="form-group col-md-5">
                    <label>Alamara</label>
                    <input type="text" class="form-control" value="" name="alamara" required>
                </div>
                <div class="form-group col-md-5">
                    <label>Rack</label>
                    <input type="text" class="form-control" value="" name="rack" required> 
                </div>
