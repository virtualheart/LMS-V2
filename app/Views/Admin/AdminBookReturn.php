        ...
        <div class="card shadow mb-2">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" value="" name="bcode" autocomplete="off" onkeyup="getDetailReturn(this.value)" oninput="this.value = this.value.toUpperCase()" maxlength="14" autofocus required>
                </div>
