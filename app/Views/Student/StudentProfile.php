        ...
        <div class="card shadow mb-2">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" value="<?=$profile['year']?>" name="yoj" id="yoj" readonly="true">
                </div>
                <div class="form-group col-md-5">
                    <label>Department & shift</label>
                    <input type="text" class="form-control" value="<?=$profile['dname']." - ".$profile['shift']?>" name="dept" id="dept" readonly="true">
                </div>

                <div class="form-group col-md-5">
                    <label>Password</label>
                    <input type="password" class="form-control" value="" placeholder="*****" name="apass" id="apass" >
                </div>
                
                <div class="form-group col-md-5">
                    <label>Confirm Password</label>
                    <input type="password" class="form-control" value="" placeholder="*****" name="capass" id="capass" >
                </div>

                <div class="form-group col-md-5">
                    <label>Email</label>
                    <input type="email" class="form-control" value="<?=$profile['stemail']?>" placeholder="studnet@gmail.com" name="mail" id="mail" >
                </div>
